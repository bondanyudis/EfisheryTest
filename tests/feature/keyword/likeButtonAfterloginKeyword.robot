...
And User click like button
    click element               xpath=/html/body/ytmusic-app/ytmusic-app-layout/div[3]/ytmusic-browse-response/ytmusic-section-list-renderer/div[2]/ytmusic-shelf-renderer/div[2]/ytmusic-responsive-list-item-renderer[1]/ytmusic-menu-renderer/div/ytmusic-like-button-renderer/tp-yt-paper-icon-button[2]/tp-yt-iron-icon
Then "Added to your likes" pop up appear
    sleep                       2s
    element should be visible   xpath=/html/body/ytmusic-app/ytmusic-popup-container/yt-notification-action-renderer/tp-yt-paper-toast/div/yt-formatted-string[1]
    sleep                       5s
